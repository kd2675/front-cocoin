		...
		<>
			<div className='relative flex min-h-0 flex-1 flex-col'>
				<div className='flex flex-1 flex-col overflow-y-auto pb-4'>
					<div className='flex-1 space-y-1 divide-y px-3'>
						<ul className='space-y-2 pb-2 pt-4'>
							{/*{!isToken || isToken == 'n' ? (*/}
							{/*	<>*/}
							{/*		<li>*/}
							{/*			<a*/}
							{/*				onClick={goLoginOnClick}*/}
							{/*				className='group flex cursor-pointer items-center rounded-lg p-2 text-base font-normal hover:bg-gray-200'*/}
							{/*			>*/}
							{/*				<svg*/}
							{/*					className='h-6 w-6 transition duration-75 group-hover:text-gray-900'*/}
							{/*					fill='currentColor'*/}
							{/*					viewBox='0 0 20 20'*/}
							...
							{/*				</svg>*/}
							{/*				<span className='ml-3 flex-1 whitespace-nowrap'>회원가입</span>*/}
							{/*				<span className='ml-3 inline-flex items-center justify-center rounded-full bg-gray-400 px-2 text-sm font-medium text-gray-800'>*/}
							{/*					Pro*/}
							{/*				</span>*/}
							{/*			</a>*/}
							{/*		</li>*/}
							...
							{/*				</svg>*/}
							{/*				<span className='ml-3 flex-1 whitespace-nowrap'>로그아웃</span>*/}
							{/*				<span className='ml-3 inline-flex items-center justify-center rounded-full bg-gray-400 px-2 text-sm font-medium text-gray-800'>*/}
							{/*					Pro*/}
							{/*				</span>*/}
							{/*			</a>*/}
							...
							{/*			></path>*/}
							{/*		</svg>*/}
							{/*		<span className="ml-3 flex-1 whitespace-nowrap">5번메뉴</span>*/}
							{/*	</a>*/}
							{/*</li>*/}
							<li>
								<div
						...
						<div className='space-y-2 pt-2'>
							<a
								...
								target='_blank'
								className='group flex items-center rounded-lg p-2 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-200'
							>
								<svg
