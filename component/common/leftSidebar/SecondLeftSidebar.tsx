					...
					<ul className='mb-4 flex flex-col gap-1'>
						<li>
							<a aria-current='page' className='active' href='#'>
								<button
									className='middle none center flex w-full items-center gap-4 rounded-lg bg-gradient-to-tr from-blue-600 to-blue-400 px-4 py-3 font-sans text-xs font-bold capitalize text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none'
									type='button'
								>
									<svg
										xmlns='http://www.w3.org/2000/svg'
