...
const Index = () => {
	return (
		<>
			<footer className='body-font h-32 text-gray-600'>
				<div className='container mx-auto px-5 py-24'>
					<div className='order-first flex flex-wrap text-center md:text-left'>
						<div className='w-full px-4 md:w-1/2 lg:w-1/4'>
							<h2 className='title-font mb-3 text-sm font-medium tracking-widest text-gray-900'>수북농업입니다.</h2>
						...
						<div className='w-full px-4 md:w-1/2 lg:w-1/4'>
							<h2 className='title-font mb-3 text-sm font-medium tracking-widest text-gray-900'>CATEGORIES</h2>
							<ul className='mb-10 list-none'>
								<li>
									<a className='text-gray-600 hover:text-gray-800'>First Link</a>
								</li>
				...
				<div className='bg-gray-100'>
					<div className='container mx-auto flex flex-col items-center px-5 py-6 sm:flex-row'>
						...
						<p className='mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0'>
							© 2020 Tailblocks —
							<a href='https://twitter.com/knyttneve' rel='noopener noreferrer' className='ml-1 text-gray-600' target='_blank'>
								@knyttneve
							</a>
						</p>
