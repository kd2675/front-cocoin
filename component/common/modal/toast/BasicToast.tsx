...
const BasicToast = (props: PropsType) => {
	...
	return (
		<>
			<ModalBg></ModalBg>
			<div data-modal-main="example2" className="overflow-y-auto relative ml-auto ">
				<div className="w-full">
					<div id="toast-default"
						...
						<div className="w-full font-normal text-center">Set yourself free.</div>
						<button type="button"
				...
				<Progress placeholder={'test'} value={state} onPointerEnterCapture={undefined}
									onPointerLeaveCapture={undefined} variant="gradient" size="md"></Progress>
			</div>
		</>
	)
}
