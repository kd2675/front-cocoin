...
import { NotiType, ToastType } from '@redux/reducers/modal'
...
const BasicNoti = (props: PropsType) => {
	...
	return (
		<>
			<div data-modal-main='example2' className='relative ml-auto w-full overflow-y-auto shadow-md'>
				<div className='flex flex-col items-center justify-center'>
					<div className='mx-auto flex w-full overflow-hidden rounded-lg border border-gray-300 bg-white shadow-md'>
						...
						<div className='flex w-full items-start justify-between px-2 py-2'>
							<div className='ml-2 mr-4 flex flex-col'>
								<label className='text-gray-800'>{props.title}</label>
								<p className='text-gray-500 '>{props.msg}</p>
							</div>
							<div
								onClick={props.closeFunc}
								style={{ cursor: 'pointer' }}
								className={'rounded-2xl border hover:bg-amber-50'}
							>
								<svg
