						...
						<div className="flex flex-col my-4">
							...
							<div x-data="{ show: false }" className="relative flex items-center mt-2">
								<input
									name="password"
									id="password"
									className="flex-1 p-2 pr-10 border border-gray-300 focus:outline-none
                                        focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900"
								...
								<button
									...
									className="absolute right-2
                                        bg-transparent flex items-center justify-center text-gray-700"
								>
									<svg x-show="!show" className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
										<path
											strokeLinecap="round"
									...
									<svg x-show="show" className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
						...
						<div className="flex flex-col my-4">
							...
							<div x-data="{ show: false }" className="relative flex items-center mt-2">
								<input
									...
									className="flex-1 p-2 pr-10 border border-gray-300
                                focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900"
