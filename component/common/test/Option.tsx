...
const Option = (props: PropsType) => {
	return (
		<div
			className="flex items-center justify-center min-h-screen from-blue-100 via-blue-300 to-blue-500 bg-gradient-to-br">
			<div className="w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl">
				<div className="max-w-md mx-auto space-y-6">
					<div className="space-y-4">
						<p className="text-sm font-medium text-center text-neutral-500">Select a option</p>
						<div className="relative">
							<input type="radio" name="options" id="option1-checkbox" value="1" className="hidden peer" />
							<label htmlFor="option1-checkbox"
								...
								<div className="flex items-center space-x-5">
									<svg className="w-16 h-auto" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
											 viewBox="0 0 256 256">
										<g fill="currentColor">
											<path
									...
									<div className="flex flex-col justify-start">
										...
										<div className="w-full text-sm opacity-60">The first option is cool</div>
									</div>
								</div>
							</label>
						</div>
						<div className="relative">
							<input type="radio" name="options" id="option2-checkbox" value="2" className="hidden peer" />
							<label htmlFor="option2-checkbox"
										 className="inline-flex items-center justify-between w-full p-5 bg-white border-2 rounded-lg cursor-pointer group border-neutral-200/70 text-neutral-600 peer-checked:border-blue-400 peer-checked:text-neutral-900 peer-checked:bg-blue-200/50 hover:text-neutral-900 hover:border-neutral-300">
								<div className="flex items-center space-x-5">
									<svg className="w-16 h-auto" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
											 viewBox="0 0 256 256">
									...
									<div className="flex flex-col justify-start">
										...
										<div className="w-full text-sm opacity-60">The second option is nice</div>
									</div>
								</div>
							</label>
						</div>
