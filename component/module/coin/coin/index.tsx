			...
			<div>
				...
				<div className="flex overflow-hidden bg-white">
					<div id="main-content" className="relative h-full w-full overflow-y-auto bg-gray-50">
							...
							<div className="px-4 pt-6">
								<div className="grid w-full grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-3">
									<div className="rounded-lg bg-white p-4 shadow sm:p-6 xl:p-8 2xl:col-span-2">
										<div className="mb-4 flex items-center justify-between">
											<div className="flex-shrink-0">
												<span className="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">$45,385</span>
									...
									<div className="rounded-lg bg-white p-4 shadow sm:p-6 xl:p-8 ">
										<div className="mb-4 flex items-center justify-between">
											<div>
												<h3 className="mb-2 text-xl font-bold text-gray-900">Latest Transactions</h3>
													...
													<div className="overflow-hidden shadow sm:rounded-lg">
														<table className="min-w-full divide-y divide-gray-200">
															...
															<tr>
																...
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">$2300</td>
															</tr>
															<tr className="bg-gray-50">
																<td
																	className="rounded-left whitespace-nowrap rounded-lg p-4 text-sm font-normal text-gray-900">
																	Payment refund to <span className="font-semibold">#00910</span>
																</td>
																<td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">
																	Apr 23 ,2021
																</td>
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">-$670</td>
															</tr>
															<tr>
																<td className="whitespace-nowrap p-4 text-sm font-normal text-gray-900">
																...
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">$234</td>
															</tr>
															<tr className="bg-gray-50">
																<td
																	className="rounded-left whitespace-nowrap rounded-lg p-4 text-sm font-normal text-gray-900">
																...
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">$5000</td>
															</tr>
															<tr>
																<td className="whitespace-nowrap p-4 text-sm font-normal text-gray-900">
															...
															<tr className="bg-gray-50">
																...
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">$560</td>
															</tr>
															<tr>
																<td className="whitespace-nowrap p-4 text-sm font-normal text-gray-900">
																...
																<td className="whitespace-nowrap p-4 text-sm font-semibold text-gray-900">$1437</td>
															</tr>
															</tbody>
														</table>
													</div>
								...
								<div className="mt-4 grid w-full grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
									...
									<div className="rounded-lg bg-white p-4 shadow sm:p-6 xl:p-8 ">
										<div className="flex items-center">
											<div className="flex-shrink-0">
												<span className="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">5,355</span>
									...
									<div className="rounded-lg bg-white p-4 shadow sm:p-6 xl:p-8 ">
										<div className="flex items-center">
											<div className="flex-shrink-0">
												<span className="text-2xl font-bold leading-none text-gray-900 sm:text-3xl">385</span>
										...
										<div className="block w-full overflow-x-auto">
											<table className="w-full border-collapse items-center bg-transparent">
												...
												<tr className="text-gray-500">
													<th
														className="whitespace-nowrap border-t-0 p-4 px-4 text-left align-middle text-sm font-normal">
														Organic Search
													</th>
													<td
														className="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs font-medium text-gray-900">
														5,649
													</td>
												...
												<tr className="text-gray-500">
													<th
														className="whitespace-nowrap border-t-0 p-4 pb-0 text-left align-middle text-sm font-normal">
														Email
													</th>
													<td
														className="whitespace-nowrap border-t-0 p-4 pb-0 align-middle text-xs font-medium text-gray-900">
														456
													</td>
						...
						<footer
							className="mx-4 my-6 rounded-lg bg-white p-4 shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8">
