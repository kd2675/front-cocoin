...
const SampleProfile = (props: PropsType) => {
	return (
		<>
			<div className='h-full bg-gray-200 p-8'>
				<div className='rounded-lg bg-white pb-8 shadow-xl'>
					...
					{/*		<p className='mb-1 px-6 text-xs uppercase text-gray-400'>Settings</p>*/}
					...
					{/*	</div>*/}
					{/*	<div className='py-2'>*/}
					{/*		<p className='mb-1 px-6 text-xs uppercase text-gray-400'>Feedback</p>*/}
					{/*		<button className='flex w-full items-center space-x-2 px-6 py-1.5 hover:bg-gray-200'>*/}
					{/*			<svg*/}
					{/*				xmlns='http://www.w3.org/2000/svg'*/}
					{/*				className='h-4 w-4 text-gray-400'*/}
					...
					<div className='-mt-20 flex flex-col items-center'>
						<img
							src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_X7kvpBxrmsMLFVpXhVBKUr2n8p9c8vXnVQ&s'
						...
						<div className='flex w-full flex-col 2xl:w-2/3'>
							<div className='flex-1 rounded-lg bg-white p-8 shadow-xl'>
								...
								<p className='mt-2 text-gray-700'>
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt voluptates obcaecati numquam error
									et ut fugiat asperiores. Sunt nulla ad incidunt laboriosam, laudantium est unde natus cum numquam,
									neque facere. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, magni odio magnam commodi
									sunt ipsum eum! Voluptas eveniet aperiam at maxime, iste id dicta autem odio laudantium eligendi
									commodi distinctio!
								</p>
							</div>
							<div className='mt-4 flex-1 rounded-lg bg-white p-8 shadow-xl'>
								...
								<div className='mt-4 grid grid-cols-1 gap-8 lg:grid-cols-3'>
									<div className='rounded-lg border border-gray-300 bg-gray-100 px-6 py-6 shadow-xl'>
										<div className='flex items-center justify-between'>
											<span className='text-sm font-bold text-indigo-600'>Total Revenue</span>
											<span
												className='cursor-default rounded-lg bg-gray-200 px-2 py-1 text-xs text-gray-500 transition duration-200 hover:bg-gray-500 hover:text-gray-200'>
												7 days
											</span>
										</div>
											...
											<div className='flex flex-col'>
												<div className='flex items-end'>
													...
													<div className='mb-1 ml-2 flex items-center'>
														...
														<span className='ml-0.5 text-sm font-bold text-gray-500'>3%</span>
													</div>
												</div>
											</div>
										</div>
									...
									<div className='rounded-lg border border-gray-300 bg-gray-100 px-6 py-6 shadow-xl'>
										<div className='flex items-center justify-between'>
											<span className='text-sm font-bold text-green-600'>New Orders</span>
											<span
												className='cursor-default rounded-lg bg-gray-200 px-2 py-1 text-xs text-gray-500 transition duration-200 hover:bg-gray-500 hover:text-gray-200'>
												7 days
											</span>
											...
											<div className='flex flex-col'>
												<div className='flex items-end'>
													...
													<div className='mb-1 ml-2 flex items-center'>
														...
														<span className='ml-0.5 text-sm font-bold text-gray-500'>5%</span>
													</div>
												</div>
											</div>
										</div>
									...
									<div className='rounded-lg border border-gray-300 bg-gray-100 px-6 py-6 shadow-xl'>
										<div className='flex items-center justify-between'>
											<span className='text-sm font-bold text-blue-600'>New Connections</span>
											<span
												className='cursor-default rounded-lg bg-gray-200 px-2 py-1 text-xs text-gray-500 transition duration-200 hover:bg-gray-500 hover:text-gray-200'>
												7 days
											</span>
											...
											<div className='flex flex-col'>
												<div className='flex items-end'>
													...
													<div className='mb-1 ml-2 flex items-center'>
														...
														<span className='ml-0.5 text-sm font-bold text-gray-500'>7%</span>
													</div>
												</div>
											</div>
										</div>
								...
								<div className='mt-4'>
									<canvas
										id='verticalBarChart'
										style={{ display: 'block', boxSizing: 'border-box', height: '414px', width: '828px' }}
										width='1656'
										height='828'
									></canvas>
								</div>
					...
					<div className='rounded-lg bg-white p-8 shadow-xl'>
						...
						<div
							className='mt-8 grid grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8'>
							<a
								href='#'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>UI/UX Design at Upwork</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Software Engineer at Facebook</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								<img
									...
									className='w-16 rounded-full'
								/>
								<p className='mt-1 text-center text-sm font-bold'>Carlos Friedrich</p>
								<p className='text-center text-xs text-gray-500'>Front-End Developer at Tailwind CSS</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>System Engineer at Tesla</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Software Developer at Upwork</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Software Engineer at Laravel</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Graphic Designer at Tailwind CSS</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Senior Android Developer at Google</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Creative Writer at Upwork</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Co-Founder at Alpine.js</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								<img
									...
									className='w-16 rounded-full'
								/>
								<p className='mt-1 text-center text-sm font-bold'>Benjamin Farrior</p>
								<p className='text-center text-xs text-gray-500'>Software Engineer Lead at Microsoft</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Linux System Administrator at Twitter</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Customer Support at Instagram</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Software Engineer at Twitter</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								<img
									...
									className='w-16 rounded-full'
								/>
								<p className='mt-1 text-center text-sm font-bold'>Jennifer Schultz</p>
								<p className='text-center text-xs text-gray-500'>Project Manager at Google</p>
							</a>
							<a
								href='#'
								className='flex flex-col items-center justify-center text-gray-800 hover:text-blue-600'
							...
							>
								...
								<p className='text-center text-xs text-gray-500'>Team Lead at Facebook</p>
							</a>
						</div>
					</div>
				</div>
