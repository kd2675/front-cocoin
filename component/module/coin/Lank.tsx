...
const Lank = (props: PropsType) => {
	return (
		<>
			<div className='mb-12 grid gap-x-6 gap-y-10 md:grid-cols-2 2xl:grid-cols-3'>
				<LankPiece title={"전체 자본 규모"} content={'total'} subContent={'￦13,232,123'}>
				...
				<LankPiece title={"자본 금액 1위"} content={'kimd0'} subContent={'￦13,232,123'}>
				...
				<LankPiece title={"자본 금액 꼴등"} content={'kimd0'} subContent={'￦13,232,123'}>
					<div className='absolute mx-4 -mt-4 grid h-16 w-16 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr from-blue-600 to-blue-400 bg-clip-border text-white shadow-lg shadow-blue-500/40'>
						<svg
							xmlns='http://www.w3.org/2000/svg'
							viewBox='0 0 24 24'
				...
				<LankPiece title={"전체 자본 변동률"} content={'$53k'} subContent={'more than 1h +55%'}>
				...
				<LankPiece title={"자본 상승률 1위"} content={'kimd0'} subContent={'more than 1h +55%'}>
				...
				<LankPiece title={"자본 상승률 꼴등"} content={'kimd0'} subContent={'more than 1h +55%'}>
					<div className='absolute mx-4 -mt-4 grid h-16 w-16 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr from-pink-600 to-pink-400 bg-clip-border text-white shadow-lg shadow-pink-500/40'>
						<svg
							xmlns='http://www.w3.org/2000/svg'
							viewBox='0 0 24 24'
