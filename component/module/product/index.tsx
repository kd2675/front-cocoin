...
const Index = () => {
	...
	useEffect(() => {
		dispatch(menuActions.setSubMenuNum(Number(200)))
						...
						<div className='mx-auto flex flex-wrap lg:w-4/5'>
							...
							<div className='mt-6 w-full lg:mt-0 lg:w-1/2 lg:py-6 lg:pl-10'>
								...
								<p className='leading-relaxed'>
									Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday
									carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.
								</p>
								...
								<div className='flex'>
									...
									<button className='ml-auto flex rounded border-0 bg-indigo-500 py-2 px-6 text-white hover:bg-indigo-600 focus:outline-none'>Button</button>
